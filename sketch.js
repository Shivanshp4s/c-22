...
var packageBody,ground,packageBody1,packageBody2;
...
function setup() {
   ...
   package2.scale=0.2
	...
	packageBody1 = Bodies.circle(360 , 200 , 5 , {restitution:0.2, isStatic:true});

	World.add(world, packageBody1);
	
	packageBody2 = Bodies.circle(440 , 200 , 5 , {restitution:0.2,isStatic:true});
